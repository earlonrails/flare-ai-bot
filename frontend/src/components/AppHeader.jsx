...
export const AppHeader = () => {
    return (
        <nav className="bg-gray-800 rounded-lg shadow-sm m-4">
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex shrink-0 items-center">
                            <span className="self-center text-xl font-semibold whitespace-nowrap text-white">FAB</span>
                            <img className="h-8 w-auto" src="/fire.png" alt="Your Company"></img>
                        </div>
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <a href="/FABToken" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">FABToken</a>
                            </div>
                        </div>
                    </div>
